    ...
    if (nTried > 0 && (nNew == 0 || GetRandInt(2) == 0)) {
        ...
        while (1) {
            ...
            while (vvTried[nKBucket][nKBucketPos] == -1) {
                nKBucket = (nKBucket + insecure_rand.insecure_rand32()) % ADDRMAN_TRIED_BUCKET_COUNT;
                nKBucketPos = (nKBucketPos + insecure_rand.insecure_rand32()) % ADDRMAN_BUCKET_SIZE;
            }
        ...
        while (1) {
            ...
            while (vvNew[nUBucket][nUBucketPos] == -1) {
                nUBucket = (nUBucket + insecure_rand.insecure_rand32()) % ADDRMAN_NEW_BUCKET_COUNT;
                nUBucketPos = (nUBucketPos + insecure_rand.insecure_rand32()) % ADDRMAN_BUCKET_SIZE;
            }
