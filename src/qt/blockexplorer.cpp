...
static std::string TxToRow(const CTransaction& tx, const CTxDestination& Highlight = CTxDestination(), const std::string& Prepend = std::string(), CAmount* pSum = nullptr)
{
