...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_4_SEGWIT_ACTIVATION) r = SPORK_4_SEGWIT_ACTIVATION_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if(strName == "SPORK_4_SEGWIT_ACTIVATION") return SPORK_4_SEGWIT_ACTIVATION;
    return -1;
}
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if(id == SPORK_4_SEGWIT_ACTIVATION) return "SPORK_4_SEGWIT_ACTIVATION";
