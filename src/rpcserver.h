...
extern UniValue getmempoolancestors(const JSONRPCRequest& request);
extern UniValue getmempooldescendants(const JSONRPCRequest& request);
extern UniValue getmempoolentry(const JSONRPCRequest& request);
